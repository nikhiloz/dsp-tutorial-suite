...
> **Prerequisites:** [Ch 05 — Z-Transform](../05-z-transform/tutorial.md), [Ch 06 — Frequency Response](../06-frequency-response/tutorial.md), [Ch 10 — FIR Filters](../10-digital-filters/tutorial.md)
...
See [Ch 12 — Filter Structures](../12-filter-structures/tutorial.md) for the different
...
**Next:** [Ch 12 — Filter Structures](../12-filter-structures/tutorial.md) — how to
...
![Butterworth LP response for orders 2, 4, 6, 8](plots/butterworth_orders.png)

### Chebyshev Ripple Comparison
![Chebyshev Type I with varying passband ripple](plots/chebyshev_ripple.png)

### IIR Filtering Result
![Time-domain IIR filtering of a noisy signal](plots/iir_filtering.png)
