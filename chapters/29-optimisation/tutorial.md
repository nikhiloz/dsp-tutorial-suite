...
![Radix-2 vs Radix-4](plots/radix_comparison.png)

![Throughput Comparison](plots/throughput.png)

![Twiddle Table Speedup](plots/twiddle_speedup.png)
...
| [← Ch 28: Real-Time Streaming](../28-real-time-streaming/tutorial.md) | [Index](../../reference/CHAPTER_INDEX.md) | [Ch 30: Capstone →](../30-putting-it-together/tutorial.md) |
