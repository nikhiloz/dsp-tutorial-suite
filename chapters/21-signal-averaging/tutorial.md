...
![Coherent Averaging — SNR improvement with K trials](plots/coherent_averaging.png)

![EMA vs Moving Average comparison](plots/ema_vs_ma.png)

![Median Filter — impulse noise removal](plots/median_filter.png)

## Cross-References

- [Chapter 10: Digital Filters](../10-digital-filters/tutorial.md) — moving average as FIR
- [Chapter 11: IIR Filters](../11-iir-filter-design/tutorial.md) — EMA as first-order IIR
- [Chapter 15: Correlation](../15-correlation/tutorial.md) — SNR estimation
