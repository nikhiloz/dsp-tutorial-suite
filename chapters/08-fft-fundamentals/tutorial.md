...
> **📊 FFT Processing Sequence** — [View full-size diagram →](fft_sequence.png)
...
**Previous:** [Chapter 01 — Complex Numbers](../03-complex-numbers/tutorial.md)
| **Next:** [Chapter 03 — Window Functions →](../09-window-functions/tutorial.md)
...
### FFT of Two Tones
![FFT resolving two closely-spaced sinusoids](plots/fft_two_tones.png)
