...
> **Prerequisites:** [Ch 06 — Frequency Response](../06-frequency-response/tutorial.md), [Ch 11 — IIR Filter Design](../11-iir-filter-design/tutorial.md)
...
**Next:** [Ch 13 — Spectral Analysis](../13-spectral-analysis/tutorial.md) — apply filters
...
![DF1 and DF2T produce identical outputs](plots/df1_vs_df2t.png)

### Coefficient Sensitivity
![Effect of coefficient quantization on frequency response](plots/coefficient_sensitivity.png)
