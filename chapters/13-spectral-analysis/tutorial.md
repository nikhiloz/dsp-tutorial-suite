...
> **📊 Signal Processing Pipeline** — [View full-size diagram →](signal_flow.png)
...
**Previous:** [Chapter 04 — Digital Filters](../10-digital-filters/tutorial.md)
| **Next:** [Chapter 06 — Real-Time Streaming →](../28-real-time-streaming/tutorial.md)
...
### Windowed Spectrum
![Hann-windowed FFT spectrum of a multi-tone signal](plots/windowed_spectrum.png)
