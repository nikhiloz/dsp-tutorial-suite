...
> **Prerequisites:** [Ch 03 — Complex Numbers](../03-complex-numbers/tutorial.md), [Ch 05 — Z-Transform](../05-z-transform/tutorial.md)
...
**Next:** [Ch 10 — FIR Filter Design](../10-digital-filters/tutorial.md) (design filters to spec),
then [Ch 11 — IIR Filter Design](../11-iir-filter-design/tutorial.md) (Butterworth, Chebyshev).
...
![Magnitude comparison of FIR and IIR filters](plots/fir_vs_iir_magnitude.png)

### FIR vs IIR Phase Response
![Phase comparison of FIR and IIR filters](plots/fir_vs_iir_phase.png)

### Group Delay
![FIR constant group delay vs IIR variable delay](plots/group_delay.png)

### Pole Radius and Resonance
![Effect of pole radius on Q factor](plots/pole_radius_q.png)
