...
- [Ch 15 — Correlation & Autocorrelation](../15-correlation/tutorial.md) — time-domain
  analysis of signal similarity, pitch estimation, and delay detection.
- [Ch 16 — Overlap-Add/Save](../16-overlap-add-save/tutorial.md) — efficient convolution
  for streaming data.
...
![Periodogram of a clean two-tone signal](plots/periodogram_clean.png)

### Periodogram — Noisy Signal
![High-variance periodogram of a noisy signal](plots/periodogram_noisy.png)

### Welch PSD
![Welch PSD — lower variance estimate](plots/welch_psd.png)
![Periodogram vs Welch comparison](plots/periodogram_vs_welch.png)

### Resolution vs Variance Trade-off
![Effect of segment length on Welch resolution](plots/welch_resolution.png)
![Resolution Tradeoff](plots/resolution_tradeoff.png)

### Cross-PSD
![Cross-PSD reveals common frequency content](plots/cross_psd.png)
