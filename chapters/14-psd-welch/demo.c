...
static void demo_periodogram_clean(void)
{
    ...
    /* Plot */
    gp_plot_spectrum("14-psd-welch", "periodogram_clean",
...
static void demo_periodogram_noisy(void)
{
    ...
    gp_plot_spectrum("14-psd-welch", "periodogram_noisy",
...
static void demo_welch(void)
{
    ...
    gp_plot_spectrum("14-psd-welch", "welch_psd",
...
static void demo_welch_resolution(void)
{
    ...
    FILE *gp = gp_open("14-psd-welch", "welch_resolution", 900, 500);
    if (gp) {
...
static void demo_cross_psd(void)
{
    ...
    gp_plot_spectrum("14-psd-welch", "cross_psd",
