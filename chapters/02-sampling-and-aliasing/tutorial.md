...
> **Prerequisites:** [Ch 01 — Signals & Sequences](../01-signals-and-sequences/tutorial.md)
...
We'll explore quantization effects deeply in [Ch 18: Fixed-Point Arithmetic](../18-fixed-point/tutorial.md).
...
- [Ch 03: Complex Numbers](../03-complex-numbers/tutorial.md) — the mathematical engine that makes frequency analysis possible.
- [Ch 04: LTI Systems & Convolution](../04-lti-systems/tutorial.md) — how filters process signals sample by sample.
...
![Aliasing: under-sampled vs properly-sampled sine](plots/aliasing.png)

### Quantization Effects
![Quantization at different bit depths](plots/quantization.png)

### Signal Reconstruction
![Sinc interpolation reconstruction](plots/reconstruction.png)
