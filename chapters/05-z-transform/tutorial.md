...
> **Prerequisites:** [Ch 01 — Signals & Sequences](../01-signals-and-sequences/tutorial.md), [Ch 03 — Complex Numbers](../03-complex-numbers/tutorial.md), [Ch 04 — LTI Systems](../04-lti-systems/tutorial.md)
...
- [Ch 06: Frequency Response, Poles & Zeros](../06-frequency-response/tutorial.md) — visual analysis of magnitude/phase plots.
- [Ch 07: The DFT](../07-dft-theory/tutorial.md) — the Z-transform evaluated at N equally-spaced points on the unit circle.
...
![First-order lowpass magnitude response](plots/lowpass_response.png)

### Resonance Peak
![Pole near unit circle creates resonance](plots/resonance.png)
