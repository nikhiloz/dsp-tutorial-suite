...
| # | Chapter | Demo | Status |
|---|---------|------|--------|
| 01 | [Discrete-Time Signals & Sequences](../01-signals-and-sequences/tutorial.md) | `ch01` | ✅ |
| 02 | [Sampling, Aliasing & Nyquist](../02-sampling-and-aliasing/tutorial.md) | `ch02` | ✅ |
| 03 | [Complex Numbers & Euler's Formula](../03-complex-numbers/tutorial.md) | `ch03` | ✅ |
| 04 | [LTI Systems & Discrete Convolution](../04-lti-systems/tutorial.md) | `ch04` | ✅ |

### Part II — Transform Domain

| # | Chapter | Demo | Status |
|---|---------|------|--------|
| 05 | [The Z-Transform](../05-z-transform/tutorial.md) | `ch05` | ✅ |
| 06 | Frequency Response, Poles & Zeros | — | 🔜 |
| 07 | [The DFT — Theory & Properties](../07-dft-theory/tutorial.md) | `ch07` | ✅ |
| 08 | [FFT Algorithms — Cooley-Tukey Radix-2](../08-fft-fundamentals/tutorial.md) | `ch08` | ✅ |
| 09 | [Window Functions & Spectral Leakage](../09-window-functions/tutorial.md) | `ch09` | ✅ |

### Part III — Filter Design

| # | Chapter | Demo | Status |
|---|---------|------|--------|
| 10 | [FIR Filter Design](../10-digital-filters/tutorial.md) | `ch10` | ✅ |
...
| # | Chapter | Demo | Status |
|---|---------|------|--------|
| 13 | [Spectral Analysis](../13-spectral-analysis/tutorial.md) | `ch13` | ✅ |
...
| 28 | [Real-Time System Design](../28-real-time-streaming/tutorial.md) | — | 📋 Design |
| 29 | [SIMD & Hardware Optimisation](../29-optimisation/tutorial.md) | — | 📋 Design |
| 30 | [End-to-End Projects](../30-putting-it-together/tutorial.md) | `ch30` | ✅ |
...
**Next:** [Chapter 01 — Discrete-Time Signals & Sequences →](../01-signals-and-sequences/tutorial.md)
