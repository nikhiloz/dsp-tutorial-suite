...
![AM Envelope Detection](plots/am_envelope.png)

![Instantaneous Frequency](plots/inst_frequency.png)

## Cross-References

- [Chapter 10: Digital Filters](../10-digital-filters/tutorial.md) — Type III FIR structure
- [Chapter 08: FFT Fundamentals](../08-fft-fundamentals/tutorial.md) — FFT-based analytic signal
- [Chapter 03: Complex Numbers](../03-complex-numbers/tutorial.md) — complex magnitude and phase
