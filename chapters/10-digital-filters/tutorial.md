...
**Previous:** [Chapter 03 — Window Functions](../09-window-functions/tutorial.md)
| **Next:** [Chapter 05 — Spectral Analysis →](../13-spectral-analysis/tutorial.md)
...
### Lowpass FIR Kernel
![FIR lowpass filter coefficients (sinc-windowed)](plots/lowpass_kernel.png)

### Noise Reduction
![Original noisy signal vs FIR-filtered output](plots/noise_reduction.png)
