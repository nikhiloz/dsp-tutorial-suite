...
![LMS Learning Curve](plots/lms_learning_curve.png)

![NLMS Noise Cancellation](plots/nlms_noise_cancel.png)

![Convergence Comparison](plots/convergence_compare.png)
