...
![Remez Bandpass Filter Response](plots/remez_bandpass.png)

![Remez vs Window Method Comparison](plots/remez_vs_window.png)

## Cross-References

- [Chapter 10: Digital Filters](../10-digital-filters/tutorial.md) — Window method comparison
- [Chapter 09: Window Functions](../09-window-functions/tutorial.md) — Window shapes
- [Chapter 17: Multirate DSP](../17-multirate-dsp/tutorial.md) — Remez filters for anti-alias
