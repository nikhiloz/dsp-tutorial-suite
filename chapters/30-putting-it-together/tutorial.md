...
**Previous:** [Chapter 07 — Optimisation](../29-optimisation/tutorial.md)
| **Back to start:** [Chapter 00 — Overview](../00-overview/tutorial.md)
...
![Full pipeline: original, filtered, and reconstructed signals](plots/pipeline_time.png)

### Pipeline Frequency Domain
![Spectrum before and after filtering](plots/pipeline_spectrum.png)
