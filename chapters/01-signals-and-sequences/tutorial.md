...
- The FFT of an impulse is flat (all frequencies equal) — see [Ch 08](../08-fft-fundamentals/tutorial.md).
...
(see [Ch 05](../05-z-transform/tutorial.md)).
...
This is Euler's formula in action (see [Ch 03](../03-complex-numbers/tutorial.md)). The
...
(See [Ch 04](../04-lti-systems/tutorial.md) for the full LTI story.)
...
- [Ch 02: Sampling, Aliasing & the Nyquist Theorem](../02-sampling-and-aliasing/tutorial.md) — why discrete-time signals exist, and the rules that govern them.
- [Ch 03: Complex Numbers](../03-complex-numbers/tutorial.md) — the mathematical engine behind frequency analysis.
...
### Unit Impulse
![Unit impulse signal](plots/impulse.png)

### Cosine Wave
![Cosine signal at various frequencies](plots/cosine.png)

### Exponential Signals
![Growing and decaying exponentials](plots/exponentials.png)

### Chirp Signal
![Linear chirp (frequency sweep)](plots/chirp.png)

### Multi-tone Signal
![Sum of three sinusoids](plots/multitone.png)
