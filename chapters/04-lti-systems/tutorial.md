...
> **Prerequisites:** [Ch 01 — Signals & Sequences](../01-signals-and-sequences/tutorial.md), [Ch 02 — Sampling & Aliasing](../02-sampling-and-aliasing/tutorial.md)
...
and difference equations come in [Ch 11: IIR Filter Design](../11-iir-filter-design/tutorial.md).
...
- [Ch 05: Z-Transform](../05-z-transform/tutorial.md) — the algebraic framework that turns convolution into multiplication.
- [Ch 06: Frequency Response, Poles & Zeros](../06-frequency-response/tutorial.md) — what convolution looks like in the frequency domain.
...
![Input, impulse response, and convolution output](plots/convolution.png)

### Cross-Correlation
![Cross-correlation showing signal alignment](plots/cross_correlation.png)
