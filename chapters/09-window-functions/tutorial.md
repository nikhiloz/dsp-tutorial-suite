...
The [windowed-sinc lowpass](../10-digital-filters/tutorial.md) in Chapter 04 uses
...
**Previous:** [Chapter 02 — FFT Fundamentals](../08-fft-fundamentals/tutorial.md)
| **Next:** [Chapter 04 — Digital Filters →](../10-digital-filters/tutorial.md)
...
### Window Shapes
![Rectangular, Hamming, Hann, and Blackman windows](plots/window_shapes.png)

### Spectral Leakage
![Window effect on spectral leakage](plots/spectral_leakage.png)
