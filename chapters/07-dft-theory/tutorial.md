...
- [Ch 08: FFT Algorithms](../08-fft-fundamentals/tutorial.md) — Cooley-Tukey Radix-2 DIT, the O(N log N) breakthrough.
- [Ch 09: Window Functions](../09-window-functions/tutorial.md) — controlling spectral leakage in finite-length DFTs.
...
### DFT of a Pure Tone
![DFT magnitude spectrum of a single sinusoid](plots/dft_spectrum.png)

### Standard Signals DFT
![DFT of impulse, DC, and alternating signals](plots/standard_signals_dft.png)

### Zero-Padding Effect
![Spectral interpolation via zero-padding](plots/zero_padding.png)
